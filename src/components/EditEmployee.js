...
// export default function EditEmployee({id, setEdit}) {
...
//     e.preventDefault();
//     console.log(state);
//     axios.put(edit_url,state).then((response)=>{
...
//             type="text"
//             name="aadharNumber"
//             defaultValue={data.aadharNumber}
//             onChange={(e)=>handleEdit(e)}
//           />
//         </div> */}
//         <div className="form-control">
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className='add_form'>
                                ...
                                <div class="form-outline">
                                    <input type="text" id="firstName" class="form" placeholder='First Name' value={formik.values.firstName}  onChange={formik.handleChange} />
